...
def test_signup(client):
    ...
    try:
        response = client.post('/signUp', data=json.dumps(formData), content_type='application/json')
...
def test_login(client): # Unit Test for Login
    ...
    response = client.post('/login', data=json.dumps(formData), content_type='application/json')
...
def test_postJob(client): # Unit Test for Post Job
    ...
    response = client.post('/postJob', data=json.dumps(formData), content_type='application/json')
    # response.status_code=200
...
def test_applyJob(client, app_ctx): # Unit Test for Apply Job
    ...
    response = client.post('/applyJob', data=json.dumps(formData), content_type='application/json')
    assert response.status_code==200
...
def test_selectStudent(client, app_ctx): # Unit Test for Student Selection
    ...
    response = client.post('/selectStudent', data=json.dumps(formData), content_type='application/json')
    # response.status_code=200
...
def test_deleteJob(client, app_ctx): # Unit Test for Delete Job
    ...
    response = client.post('/deleteJob', data=json.dumps(formData), content_type='application/json')
    # response.status_code=200
...
def test_deleteUser(client, app_ctx): # Unit Test for Delete User
    ...
    response = client.post('/deleteUser', data=json.dumps(formData), content_type='application/json')
    # response.status_code=200
